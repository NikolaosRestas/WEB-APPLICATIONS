...
import com.example.demo2.Repository.ProgramRepository;
...
public class GymProgramService {
    private final ProgramRepository gymprogramRepo;

    public GymProgramService(ProgramRepository gymprogramRepo){
